...
import { l as Menu, W as Wallet, P as Plus, I as Info, p as ShoppingBag, h as Leaf, d as ChevronRight } from "../_libs/lucide-react.mjs";
...
function RestaurantDashboard() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "phone-frame flex min-h-screen flex-col", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-5", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-2xl font-bold", children: "Hola, La Leñadora 👋" }),
