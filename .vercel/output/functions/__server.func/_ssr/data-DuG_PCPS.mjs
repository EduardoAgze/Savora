...
const PACKS = [
  {
    ...
    pickupUntil: "22:00",
    category: ["Cena"],
    description: "Crujiente cuarto de pollo broaster acompañado de papas fritas doradas. Preparado hoy con pollo fresco y especias de la casa.",
    co2Kg: 2.5,
  ...
  },
  {
    ...
    pickupUntil: "20:30",
    category: ["Cena"],
    description: "Lomito de carne tierna en pan artesanal con lechuga fresca y aderezos especiales. El sándwich más pedido de la casa.",
    co2Kg: 1.8,
  ...
  },
  {
    ...
    pickupUntil: "23:00",
    category: ["Cena"],
    description: "Jugosa hamburguesa de carne a la parrilla con queso, tomate, lechuga y papas fritas crocantes. Combo completo del día.",
    co2Kg: 3.1,
  ...
  },
  {
    ...
    pickupUntil: "21:00",
    category: ["Cena"],
    description: "Tallarín salteado al wok con pollo, verduras frescas y salsa de soja. Receta tradicional china con un toque especial de la casa.",
    co2Kg: 1.4,
