...
import { g as Compass, R as Receipt, W as Wallet, t as User, L as LayoutDashboard, C as CalendarCheck, n as Settings } from "../_libs/lucide-react.mjs";
const tabs = [
...
function RestaurantTabBar() {
  const { pathname } = useLocation();
  return /* @__PURE__ */ jsxRuntimeExports.jsx("nav", { className: "sticky bottom-0 left-0 right-0 z-20 border-t bg-card/95 backdrop-blur", children: /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "grid grid-cols-4", children: rTabs.map(({ to, label, icon: Icon }) => {
      ...
      Link,
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "span",
            {
              className: "flex h-9 w-12 items-center justify-center rounded-full transition " + (active ? "bg-primary text-primary-foreground" : "text-muted-foreground"),
              children: /* @__PURE__ */ jsxRuntimeExports.jsx(Icon, { className: "h-4 w-4" })
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
